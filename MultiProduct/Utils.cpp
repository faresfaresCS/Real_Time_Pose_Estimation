...
{
    cv::putText(image, text, cv::Point(25,950), fontFace, 1.3, color, 3, 8);
}
...
{
    cv::putText(image, text, cv::Point(25,900), fontFace, 1.3, color, 3, 8);
}

void drawText6(cv::Mat image, std::string text, cv::Scalar color)
{
    cv::putText(image, text, cv::Point(25,1000), fontFace, 1.3, color, 3, 8);
}
